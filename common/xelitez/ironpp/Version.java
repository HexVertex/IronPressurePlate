...
public class Version 
{
	...
	public static void checkForUpdates()
	{
		...
		for(int i = 0; i < strings.size();i++)
		{
			...
			{
				if(line.contains("public static int majorVersion"))
				{
					line = line.substring(line.indexOf("= ") + 2, line.indexOf(';'));
					MV = Integer.parseInt(line);
				}
				if(line.contains("public static int minorVersion"))
				{
					line = line.substring(line.indexOf("= ") + 2, line.indexOf(';'));
					mV = Integer.parseInt(line);
				}
				if(line.contains("public static int majorBuild"))
				{
					line = line.substring(line.indexOf("= ") + 2, line.indexOf(';'));
					MB = Integer.parseInt(line);
				}
				if(line.contains("public static int minorBuild") && !ignoremB)
				{
					line = line.substring(line.indexOf("= ") + 2, line.indexOf(';'));
					mB = Integer.parseInt(line);
				}
				if(line.contains("public static String MC") && line.contains("MC:") && !line.contains("\"MC:\""))
				{
