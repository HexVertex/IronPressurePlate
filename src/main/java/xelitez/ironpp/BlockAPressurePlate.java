...
public class BlockAPressurePlate extends BlockContainer
{
    ...
    protected BlockAPressurePlate(String par1, Material par2Material)
    {
        super(par2Material);
        this.triggerMobType = Sensitivity.everything;
    ...
    {
        return World.doesBlockHaveSolidTopSurface(par1World, par2, par3 - 1, par4) || BlockFence.func_149825_a(par1World.getBlock(par2, par3 - 1, par4)) || IronPP.getNonSolidBlockEnabled(par1World.getBlock(par2, par3 - 1, par4), par1World.getBlockMetadata(par2, par3 - 1, par4));
    }

    @Override
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack)
    {
        if (par5EntityLivingBase instanceof EntityPlayer && par1World.getTileEntity(par2, par3, par4) != null && par1World.getTileEntity(par2, par3, par4) instanceof TileEntityPressurePlate)
        {
            TileEntityPressurePlate tpp = (TileEntityPressurePlate)par1World.getTileEntity(par2, par3, par4);
            tpp.registerPlayer(((EntityPlayer)par5EntityLivingBase).getCommandSenderName());

            if (!par1World.isRemote || FMLCommonHandler.instance().getSide().isServer())
            {
                PacketSendManager.sendAddPressurePlateToClient(tpp, par1World.provider.dimensionId);
                PacketSendManager.sendUsesPasswordToClient(par2, par3, par4, par1World.provider.dimensionId, tpp.getIsEnabled(2));

                if (tpp.item[0] != null)
                {
                    PacketSendManager.sendItemStackToClients(par2, par3, par4, tpp.item[0].getItem(), tpp.item[0].getItemDamage(), tpp.item[0].stackSize, par1World.provider.dimensionId);
                }
                else
                {
                    PacketSendManager.sendItemStackToClients(par2, par3, par4, Item.getItemById(0), 0, 0, par1World.provider.dimensionId);
                }
            }
        }
    }
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, Block par5Block)
    {
        ...
        if (!World.doesBlockHaveSolidTopSurface(par1World, par2, par3 - 1, par4) && !BlockFence.func_149825_a(par1World.getBlock(par2, par3 - 1, par4)) && !IronPP.getNonSolidBlockEnabled(par1World.getBlock(par2, par3 - 1, par4), par1World.getBlockMetadata(par2, par3 - 1, par4)))
        {
            var6 = true;
        }
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        {
        	if(((TileEntityPressurePlate)par1World.getTileEntity(par2, par3, par4)).currentOutput != 0)
        	{
    ...
    private void setStateIfMobInteractsWithPlate(World par1World, int par2, int par3, int par4)
    {
        ...
        if (par1World.getTileEntity(par2, par3, par4) instanceof TileEntityPressurePlate)
        {
            ...
            {
                if (var8.size() > 0 && (((TileEntityPressurePlate)par1World.getTileEntity(par2, par3, par4)).findMobName(EntityList.getEntityString((Entity)var8.get(var10)))))
                {
                    var6 = true;
                }
...

                {
                    ...
                    {
                        if (((TileEntityPressurePlate)par1World.getTileEntity(par2, par3, par4)).findMobName("humanoid"))
                        {
                            if (((TileEntityPressurePlate)par1World.getTileEntity(par2, par3, par4)).isPlayerInList(((EntityPlayer)var8.get(var10)).getCommandSenderName()))
                            {
                                if (((TileEntityPressurePlate)par1World.getTileEntity(par2, par3, par4)).isInPlayerList(((EntityPlayer)var8.get(var10)).getCommandSenderName()))
                                {
                                    var6 = true;
                                }
                            }
                            ...
                            {
                                if (((TileEntityPressurePlate)par1World.getTileEntity(par2, par3, par4)).getIsEnabled(0))
                                {
                                    var6 = true;
                                }
                            }
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, Block par5, int par6)
    {
        ...
        PacketSendManager.sendCloseGuiPacketToAllPlayers(((TileEntityPressurePlate)par1World.getTileEntity(par2, par3, par4)));
        TileEntityPressurePlate var7 = (TileEntityPressurePlate)par1World.getTileEntity(par2, par3, par4);
        ...
        if (var7 != null)
        {
            ...
            PPRegistry.removePressurePlate(var7, par1World.provider.dimensionId);

            if (!par1World.isRemote || FMLCommonHandler.instance().getSide().isServer())
            {
                PacketSendManager.sendRemovePressurePlateToClient(var7, par1World.provider.dimensionId);
            }
        }
    ...
    {
        boolean var5 = ((TileEntityPressurePlate)par1IBlockAccess.getTileEntity(par2, par3, par4)).currentOutput > 0;
        float var6 = 0.0625F;
    ...
    {
    	return ((TileEntityPressurePlate)par1IBlockAccess.getTileEntity(par2, par3, par4)).currentOutput;
    }

    @Override
    public int isProvidingStrongPower(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5)
    {
        return par5 == 1 ? ((TileEntityPressurePlate)par1IBlockAccess.getTileEntity(par2, par3, par4)).currentOutput : 0;
    }
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        if (FMLCommonHandler.instance().getSide().isServer())
        {
            if (PPRegistry.getUsesPassword((TileEntityPressurePlate)te, par1World.provider.dimensionId))
            {
                ...
                PacketSendManager.sendPPIntToClient(1, (EntityPlayerMP) par5EntityPlayer);
                return true;
            }
            else
            {
    ...
    public IIcon getIcon(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5)
    {
    	...
    	if (item != null && item.getItem() != Item.getItemFromBlock(IronPP.APressurePlateIron))
    	{
    		return Block.getBlockFromItem(item.getItem()).getIcon(par5, item.getItemDamage());
    	}
    ...
    public int colorMultiplier(IBlockAccess par1IBlockAccess, int par2, int par3, int par4)
    {
    	...
    	if (item != null && item.getItem() != Item.getItemFromBlock(IronPP.APressurePlateIron))
    	{
    		return Block.getBlockFromItem(item.getItem()).colorMultiplier(par1IBlockAccess, par2, par3, par4);
    	}
        ...
        if (te != null && te instanceof TileEntityPressurePlate)
        {
            ...
            if (FMLCommonHandler.instance().getEffectiveSide().isServer())
            {
                if (tpp.getIsEnabled(3) && !player.capabilities.isCreativeMode)
                {
                    ...
                    PacketSendManager.sendPPIntToClient(2, (EntityPlayerMP) player);
                }
                else
                {
