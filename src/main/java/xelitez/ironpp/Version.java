...
public class Version
{
    ...
    public static int minorBuild = 29;
    ...
    public static void checkForUpdates()
    {
    	...
    	try
    	{	
    		URL url = new URL("https://raw.githubusercontent.com/XEZKalvin/IronPressurePlate/master/src/main/java/xelitez/ironpp/Version.java");
    	...
    	{
    		FMLLog.info("IronPP", "Unable to check for updates");
    	}
    	catch (ConnectException e)
    	{
    		FMLLog.info("IronPP", "Unable to connect to update page");
    	} 
    	catch (IOException e) {
    		FMLLog.info("IronPP", "Unable to check for updates");
    		return;
    	...
    	{
    		FMLLog.info("IronPP", "A new version of the Iron Pressure Plate mod is available(" + newVersion + ")");
    	}
