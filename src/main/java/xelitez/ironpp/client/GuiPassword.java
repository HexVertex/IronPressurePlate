...
{
    private static PasswordTextField theGuiTextField;
    ...
    public void initGui()
    {
        ...
        GuiPassword.theGuiTextField = new PasswordTextField(this.fontRendererObj, this.width / 2 - 100, 60, 200, 20);
    ...
    private static class PasswordTextField extends Gui
    {
        ...
        public PasswordTextField(FontRenderer par1FontRenderer, int par2, int par3, int par4, int par5)
        {
        ...
        public void drawTextBox()
        {
            if (this.func_73778_q())
            {
                ...
                if (var4.length() > 0)
                {
                    ...
                    var9 = this.fontRenderer.drawStringWithShadow(str, var7, var8, var1);
                }
