...
public class Pipeline extends MessageToMessageCodec<FMLProxyPacket, Packet> {
    ...
    public void initalise() {
        this.channels = NetworkRegistry.INSTANCE.newChannel("IPP", this);
        this.registerPacket(PacketPressurePlateData.class);
    }
